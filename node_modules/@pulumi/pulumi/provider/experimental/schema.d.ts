...
export declare function generateSchema(packageJSON: Record<string, any>, components: Record<string, ComponentDefinition>, typeDefinitions: Record<string, TypeDefinition>, packageReferences: Record<string, string>): PackageSpec;
